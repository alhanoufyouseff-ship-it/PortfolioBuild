...
export default function LoginModal({ open, onClose }: { open: boolean; onClose: () => void }) {
  ...
  return (
    <div className="modal-overlay fixed inset-0 z-50 flex items-center justify-center px-4">
      <div className="glass-panel w-full max-w-sm rounded-2xl border border-white/10 p-6 shadow-2xl">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-lg font-bold text-white flex items-center gap-2.5">
            <span className="w-8 h-8 rounded-lg bg-gradient-primary flex items-center justify-center text-white text-sm">
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          <button
            ...
            className="w-full rounded-lg bg-gradient-primary py-2 text-sm font-bold text-white glow-btn disabled:opacity-50"
          >
        ...
        <button
          ...
          disabled={busy || !configured}
          className="w-full rounded-lg border border-white/10 bg-white/5 py-2 text-sm font-semibold text-white hover:bg-white/10 disabled:opacity-50 flex items-center justify-center gap-2"
        >
